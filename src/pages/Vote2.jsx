...
export default function Vote2() {
  ...
  return (
    <div className="w-full h-full flex flex-col items-center bg-white">
      <div className="h-14 bg-[#0058B1] flex row
      w-full items-center justify-between">
        <div className='font-bold text-2xl ml-4
        text-white border-solid'>
        2. Elección de candidatos a DIPUTADOS por el
        departamento de San Salvador</div>
        <div><img src={logo} className='w-14' /></div>
      </div>
      <div className='my-2 mx-20 text-center text-sm'>
      Marque de 1 a 16 casillas de acuerdo a sus preferencias por los candidatos
      </div>
