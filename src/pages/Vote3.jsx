    ...
    return (
        <div className="w-full h-full flex flex-col items-center bg-white">
            <div className="h-14 bg-[#0058B1] flex row w-full items-center justify-between">
                <div className='font-bold text-2xl ml-4 text-white border-solid'>3. Elección de candidato a ALCALDE por el municipio de San Salvador Centro</div>
                <div><img src={logo} className='w-14' /></div>
            </div>
            <div className='my-2 mx-20 text-center text-sm'>Si apoya al candidato para la alcaldía de San Salvador Centro, presione el botón “SI”.  Si no lo apoya presione el botón “No” 
